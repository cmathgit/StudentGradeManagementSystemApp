...
# Structured Analysis and Design information located in the /docs folder. For comprehensive findings, please see 
```
/docs/SGMS_Proposal_and_Report.pdf
```
# Here you will find PERT and Gannt Charts, Cost Estimation using COCOMO Model, Software Robustness Index Testing, Business and Functional Requirements (BRD, FRD, TRD) Gathering and Analysis, DFDs and Data Dictionaries, Domain and Data Modeling, UI Design, System Architecture Design, Interface Specification, Security Analysis, QA Planning, and Risk Id.

# More Use Cases can be found in:
```
/docs/SGMS_UML_Diagrams_and_UseCases.pdf
```

# Dummy data has been provided in the /data folder

# Complete BRDs, FRDs, and TRDs can be found in:
```
/docs/SGMS_FRD.pdf
```
...
# 2. We will need to provide our own server to create and manage the database system. Various packages may need to be imported into the project.
